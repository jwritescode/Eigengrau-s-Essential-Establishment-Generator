setup.closestMatch = function (Arr, Prop1, Prop2, Val1, Val2) {
  var range1
  var range2
  var scale1 = 1
  var scale2 = 1
  // Find highest and lowest values for each property in the array.
  var min1 = Arr[0][Prop1]
  var min2 = Arr[0][Prop2]
  var max1 = Arr[0][Prop1]
  var max2 = Arr[0][Prop2]
  ...
  var curdist
  var closest = 0
  var dist = (Math.abs(Arr[0][Prop1] - Val1) * scale1) + (Math.abs(Arr[0][Prop2] - Val2) * scale2)
